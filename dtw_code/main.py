...
parser.add_argument('--steps_loss', type=int, default=10, help='the number of mini-batch update steps for learning the loss model parameters')
parser.add_argument('--steps_prediction', type=int, default=10, help='the number of mini-batch update steps for learning')
