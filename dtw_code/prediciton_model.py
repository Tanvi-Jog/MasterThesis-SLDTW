...
class PredictionModel(nn.Module):
  """
  This model does time series forecasting for given sequence length and forecast horizon. The architecture replicates
  the best performing architecture. HP for the CNN are fixed and must be avoided for replicating the original results.
  """
